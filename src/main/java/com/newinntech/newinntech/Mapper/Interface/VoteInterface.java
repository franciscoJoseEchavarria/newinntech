...
public interface VoteInterface {
    ...
    @Mapping( target = "voter.id", source = "voter.id")   //sale voterRequest y entra voterModel
    @Mapping( target = "candidate.id" ,source = "candidate.id") //sale candidateRequest y entra candidateModel
    VoteModel mapVoteRequestToVoteModel(VoteRequest voteRequest);

    @Mapping( target = "voter.id", source = "voter.id") //sale voterModel y entra voterResponse
    @Mapping(target = "candidate.id", source = "candidate.id" ) //sale candidateModel y entra candidateResponse
